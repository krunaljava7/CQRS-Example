package com.cqrs.cqrsActiveMQdemo.configuration;
...
public class AxonConfig {
     ...
     */
    @Bean
    public Repository<SampleDomainObject> eventSourcingRepository() {
        EventSourcingRepository eventSourcingRepository = new EventSourcingRepository(SampleDomainObject.class, jdbcEventStore());
